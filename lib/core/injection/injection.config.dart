...
import 'package:kodjaz/core/client/client.dart' as _i11;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i9.LessonRepository>(
        () => _i10.LessonRepositoryImpl(gh<_i11.Api>()));
    gh.singleton<_i12.AuthBloc>(_i12.AuthBloc(gh<_i5.AuthRepository>()));
    gh.lazySingleton<_i13.HomeBloc>(
        () => _i13.HomeBloc(gh<_i7.HomeRepository>()));
    gh.lazySingleton<_i14.LessonBloc>(
        () => _i14.LessonBloc(gh<_i9.LessonRepository>()));
    return this;
  }
}
