...
import 'package:kodjaz/core/injection/register_module.dart' as _i12;
...
import 'package:kodjaz/features/auth/bloc/auth_bloc.dart' as _i10;
...
import 'package:kodjaz/features/auth/repository/auth_repository_impl.dart'
    as _i7;
import 'package:kodjaz/features/home/presentation/bloc/home_bloc.dart' as _i11;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.singleton<_i10.AuthBloc>(_i10.AuthBloc(gh<_i6.AuthRepository>()));
    gh.lazySingleton<_i11.HomeBloc>(
        () => _i11.HomeBloc(gh<_i8.HomeRepository>()));
    return this;
  }
}
