...
import 'package:kodjaz/core/injection/register_module.dart' as _i16;
...
import 'package:kodjaz/features/articles/presentation/bloc/article_bloc.dart'
    as _i6;
import 'package:kodjaz/features/auth/bloc/auth_bloc.dart' as _i13;
...
import 'package:kodjaz/features/auth/repository/auth_repository_impl.dart'
    as _i8;
import 'package:kodjaz/features/home/presentation/bloc/home_bloc.dart' as _i14;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.singleton<_i13.AuthBloc>(_i13.AuthBloc(gh<_i7.AuthRepository>()));
    gh.lazySingleton<_i14.HomeBloc>(
        () => _i14.HomeBloc(gh<_i9.HomeRepository>()));
    gh.lazySingleton<_i15.LessonBloc>(
        () => _i15.LessonBloc(gh<_i11.LessonRepository>()));
    return this;
  }
}
